    ...
    <>
      <Modal
        content={{
          ...
          didYouKnow:
            'Did you know that for 1/5 of CIOs, sustainability is a Key cloud priority in the next 3 years, and for 1/4, sustainable offers are a main benefice of cloud?',
        }}
